...
<center><img src="uemlog.png" width="150" height="150">
...
Designed & Developed by Abbas Khan</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Abbas Khan :: 2024</h6></center> 
  <hr class="new1">
</body>
